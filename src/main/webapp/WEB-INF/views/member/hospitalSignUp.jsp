    ...
    <div id="signup-normal">
		<div class="signup-normal-wrapper">
			<div class="signup-cont">
				<h3 class="top-title">동물병원 회원가입</h3>
					...
					<div class="signup-form-wrapper" >
						<form name="signupFrm" id="signupFrm" action="${pageContext.request.contextPath}/member/memberEnroll?${_csrf.parameterName}=${_csrf.token}" method="POST" enctype="multipart/form-data">
							<div class="necessary-info">
								...
								<div class="info-wrapper">
									<div class="label-wrapper">
										<label for="memberName">대표 수의사</label><span class="neccesary-star">*</span>
									</div>
								...
								<div class="info-wrapper-with-msg">
									<div class="inner-wrapper">
										<div class="label-wrapper">
											<label for="nickname">병원명</label><span class="neccesary-star">*</span>
										</div>
									...
									<div class="msg-wrapper msg-nickname">
										<div class="void-space">&nbsp;</div>
										<span class="nickname-result ok">사용가능한 병원명입니다.</span>
										<span class="nickname-result fail">중복되는 병원명입니다.<br>병원명 앞에 지역명을 붙여보세요.</span>
										
									</div>
								</div>
								<div class="info-wrapper">
									<div class="label-wrapper">
										<label for="phone">병원 대표번호</label><span class="neccesary-star">*</span>
									</div>
...
function emailCert() {
    ...
    if(!inputId  || !inputName) {
      alert("아이디 혹은 대표 수의사명을 먼저 작성해주세요.");
      return false;
    }
    else if(!inputEmail){
    	alert("이메일을 작성해주세요.");
