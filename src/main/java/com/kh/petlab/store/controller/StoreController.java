...
public class StoreController {
	...
	public ModelAndView productFeed(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			List<ProductAttachment> attlist = storeService.selectattFeedList();
			log.debug("list = {}", list);
	...
	public ModelAndView productSnack(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			int numPerPage = 10;
			List<Product> list = storeService.selectProductList(cPage, numPerPage);
			List<ProductAttachment> attlist = storeService.selectattSnackList();
			log.debug("list = {}", list);
			mav.addObject("list", list);
			mav.addObject("attlist", attlist);
	...
	public ModelAndView productFeeding(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			int numPerPage = 10;
			List<Product> list = storeService.selectProductList(cPage, numPerPage);
			List<ProductAttachment> attlist = storeService.selectattFeedingList();
			log.debug("list = {}", list);
			mav.addObject("list", list);
			mav.addObject("attlist", attlist);
	...
	public ModelAndView productShampoo(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			int numPerPage = 10;
			List<Product> list = storeService.selectProductList(cPage, numPerPage);
			List<ProductAttachment> attlist = storeService.selectattShamList();
			log.debug("list = {}", list);
			mav.addObject("list", list);
			mav.addObject("attlist", attlist);
	...
	public ModelAndView productPad(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			int numPerPage = 10;
			List<Product> list = storeService.selectProductList(cPage, numPerPage);
			List<ProductAttachment> attlist = storeService.selectattPadList();
			log.debug("list = {}", list);
			mav.addObject("list", list);
			mav.addObject("attlist", attlist);
	...
	public ModelAndView productBrush(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			int numPerPage = 10;
			List<Product> list = storeService.selectProductList(cPage, numPerPage);
			List<ProductAttachment> attlist = storeService.selectattBrushList();
			log.debug("list = {}", list);
			mav.addObject("list", list);
			mav.addObject("attlist", attlist);
	...
	public ModelAndView productToy(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			int numPerPage = 10;
			List<Product> list = storeService.selectProductList(cPage, numPerPage);
			List<ProductAttachment> attlist = storeService.selectattToyList();
			log.debug("list = {}", list);
			mav.addObject("list", list);
			mav.addObject("attlist", attlist);
	...
	public ModelAndView producBag(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
		...
		try {
			...
			int numPerPage = 10;
			List<Product> list = storeService.selectProductList(cPage, numPerPage);
			List<ProductAttachment> attlist = storeService.selectattBagList();
			log.debug("list = {}", list);
			mav.addObject("list", list);
			mav.addObject("attlist", attlist);
	...
	public String deleteProduct(@RequestParam("productNo") int productNo, Product product, RedirectAttributes rt) {
	...
	public String updateProduct(@ModelAttribute Product product, @RequestParam("productNo") int productNo,
			@RequestParam("upFile") MultipartFile[] upFiles,
			@RequestParam(value = "delFile", required = false) int[] delFiles, RedirectAttributes redirectAttr)
			throws Exception {
		String saveDirectory = application.getRealPath("/resources/upload/store/mall");
	 ...
	 * // 상품목록(사료)
	 * 
	 * @GetMapping("/mall/feedMain") public ModelAndView
	 * feedproductList(@RequestParam(defaultValue = "1") int cPage, ModelAndView
	 * mav, HttpServletRequest request) { try { // 목록조회 int numPerPage = 10;
	 * List<Product> list = storeService.selectProductList(cPage, numPerPage);
	 ...
	 * PetLabUtils.getPagebar(cPage, numPerPage, totalContent, url);
	 * 
	 * mav.addObject("pagebar", pagebar);
	 * 
	 * 
	 ...
	 * 
	 * } catch (Exception e) { log.error("상품(목욕) 목록 조회 오류", e); } return mav; }
	 * 
	 * // 상품목록(목욕)
	 * 
	 * @GetMapping("/mall/bathMain") public ModelAndView
	 * bathproductList(@RequestParam(defaultValue = "1") int cPage, ModelAndView
	 * mav, HttpServletRequest request) { try { // 목록조회 int numPerPage = 10;
	 * List<Product> list = storeService.selectProductList(cPage, numPerPage);
	 * log.debug("list = {}", list); mav.addObject("list", list);
	 * 
	 ...
	 * // 상품목록(기타)
	 * 
	 * @GetMapping("/mall/etcMain") public ModelAndView
	 * etcproductList(@RequestParam(defaultValue = "1") int cPage, ModelAndView mav,
	 * HttpServletRequest request) { try { // 목록조회 int numPerPage = 10;
	 * List<Product> list = storeService.selectProductList(cPage, numPerPage);
	 * //List<ProductAttachment> attlist = storeService.selectattList();
	 * 
	 * log.debug("list = {}", list); mav.addObject("list", list);
	 * //mav.addObject("attlist", attlist);
	 * 
	 ...
	 * // viewName설정 mav.setViewName("store/mall/feedMain");
	 * 
	 * } catch (Exception e) { log.error("상품(기타) 목록 조회 오류", e); } return mav; }
	 */
	/******************/
